...
@section('title', trans('site.dashboard') . ' - ' . trans('site.add_product'))
...
@section('content')
    <div class="card card-primary">
        <div class="card-header">
            <h4>@lang('site.add_product')</h4>
        </div>
        <div class="card-body">
            <form action="{{ route('dashboard.products.store') }}" method="POST" enctype="multipart/form-data" role="form">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="purchase_price" value="{{ old('purchase_price') }}" class="form-control" id="purchasePrice" placeholder="@lang('site.purchase_price')">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="sale_price" value="{{ old('sale_price') }}" class="form-control" id="salePrice" placeholder="@lang('site.sale_price')">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="stock" value="{{ old('stock') }}" class="form-control" id="stock" placeholder="@lang('site.stock')">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="image" value="{{ old('image') }}" class="form-control" id="image" placeholder="@lang('site.product_image')">

                    @error('image')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                    <div>
                        <img id="imagePreview" src="{{ asset('uploads/products_image/product.png') }}" class="img-thumbnail mt-1" style="width: 100px">
                    </div>
                </div>
